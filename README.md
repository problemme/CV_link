...
# See the webpage
Firstly make sure main.js with "createApp(App).mount('#app')", which connects App.vue with index.html
And index.html with "id = #app"
Start at the root with "npm run dev"